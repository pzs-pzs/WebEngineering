...
import com.dlb.service.impl.JobServeiceImpl;
 ...
 * @author puzhengsong  
 */
@WebServlet("/StoreJobServlet")
public class StoreJobServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		State s = new State();
		DataService service = new JobServeiceImpl();
